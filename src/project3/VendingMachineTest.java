 ...
 *
 * @generatedBy CodePro at 3/4/18 7:44 PM
 * @author Marcus
...
public class VendingMachineTest {
	...
	public void testAddItem_1()
		...
		fixture.balance = 1.0;
		VendingMachineItem item = new VendingMachineItem("cookies", 1.0);
		String code = "B";

		fixture.addItem(item, code);
		
		assertSame(item, fixture.getItem(code));
	 ...
	 * @generatedBy CodePro at 3/4/18 7:44 PM
	 */
	@Test(expected = project3.VendingMachineException.class)
	...
	public void testMakePurchase_1()
		...
		String code = "C";
		VendingMachineItem item = new VendingMachineItem("donut", 1.0);
		fixture.addItem(item, code);
